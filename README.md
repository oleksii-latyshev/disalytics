...
| [HLTV](https://www.hltv.org/) | published match media | The two sample matches under [`apps/web/assets/samples`](apps/web/assets/samples/README.md) — a professional IEM Atlanta 2026 series, shipped as parsed containers rather than as demos so the product can be tried without one. No `.dem` is committed, here or anywhere. |
