...
| #332 | The way in earns its place | **Built 6 September 2026.** A drifting gradient behind the whole shell — the first and only spend of the `ogl` approval from #200 — with the product's promise as the hero above one action. Both constraints hold: it keeps moving through a real parse, measured, and it draws one still frame under reduced motion. | P1 | M |
