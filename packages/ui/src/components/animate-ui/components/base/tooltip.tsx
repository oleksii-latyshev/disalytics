...
} from '#components/animate-ui/primitives/base/tooltip.tsx';
...
// Deviation 1 of 2 — see `UPSTREAM.md`. `@base-ui-components/react` moved `delay` off
// `Tooltip.Root` and onto `Tooltip.Provider` before 1.0.0-rc.0; upstream still types it from the
// root. The value already flows to the provider below — only the type read the wrong side.
