...
/**
 * One mark of §10.6's legend, on a canvas because that is what the plate is: a mark reproduced in
 * DOM would be a second drawing of it, and a second drawing is the drift the legend exists to
 * prevent.
 *
 * It is drawn once, when the sheet's tree mounts, rather than when the sheet opens — a swatch is
 * 56×28 and there are fourteen of them, so the cheapest moment to pay for them is the one nobody
 * is waiting on.
 */
