...
function formatClock(format: Intl.NumberFormat, seconds: number): string {
...
/**
 * One formatted value rather than a translated sentence with numbers in it: `mm:ss / mm:ss`,
 * counting past 60 minutes rather than growing an hours field a match rarely needs.
 */
